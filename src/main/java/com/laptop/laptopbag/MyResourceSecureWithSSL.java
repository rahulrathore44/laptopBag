 ...
 *	24-June-2019
 *	
 *	@see  http://localhost:8080/laptop-bag/webapi/sslres/
 */
@Path("sslres")
public class MyResourceSecureWithSSL {
	
	private Ioperation operation = new LaptopOperation();

    /**
     * @see http://localhost:8080/laptop-bag/webapi/sslres/all
    ...
    /**
     * @see http://localhost:8080/laptop-bag/webapi/sslres/find/{id}
     * @param id int
     * @return javax.ws.rs.core.Response
     */
    @GET
    ...
    /**
     * @see http://localhost:8080/laptop-bag/webapi/sslres/add
    ...
    /**
     * @see http://localhost:8080/laptop-bag/webapi/sslres/delete/{id}
     * @param id int
     * @return javax.ws.rs.core.Response
     */
    @DELETE
    ...
    /**
     * @see http://localhost:8080/laptop-bag/webapi/sslres/update
     * @param detail LaptopDetails
     * @return javax.ws.rs.core.Response
     */
    @PUT
    ...
    /**
     * @see http://localhost:8080/laptop-bag/webapi/sslres/ping
     * @param text String
     * @return String
     */
    @GET
